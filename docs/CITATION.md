...
When using the interactive explorer, figures or public visualization data, cite:
...
Additional research data supplied through the controlled-access process may carry further attribution or redistribution conditions.
