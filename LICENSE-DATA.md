# Public visualization data license

Unless a provenance record states otherwise, PARAMO-derived data embedded in the public Results Explorer and original documentation distributed through this repository are licensed under the **Creative Commons Attribution 4.0 International License (CC BY 4.0)**.

Copyright © 2026 Wilian Guamán Cuenca.

Attribution should identify **Wilian Guamán Cuenca**, **PARAMO Ecuador Results Explorer**, and the repository URL or persistent archival identifier associated with the release used. Scholarly reuse should also follow `CITATION.cff` and `docs/CITATION.md`.
